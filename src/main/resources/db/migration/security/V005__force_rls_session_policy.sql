...
-- an already-forced table is a no-op. This covers the session_policy table — and any other newly
-- RLS-enabled table — on databases already past V001/V002/V003/V004.
DO $$
DECLARE
  rel record;
BEGIN
